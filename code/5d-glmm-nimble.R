# 5d-glmm-nimble.R: this script displays how to fit a Bayesian GLMM 
...
# effect of park, and fixed effect of hydroperiod and area. You should 
# standardize the continuous area variable. Did the model converge? How 
# do you know?
